...
<section class="sec bg-gray">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<a href="<?= get_permalink(36) ?>" class="bnr" style="background-image: url('<?= get_template_directory_uri() ?>/assets/img/home/bnr_about@2x.jpg')">
					<div class="bnr_inner">
			...
			<div class="col-md-6">
				<a href="<?= get_permalink(44) ?>" class="bnr" style="background-image: url('<?= get_template_directory_uri() ?>/assets/img/home/bnr_access@2x.jpg')">
					<div class="bnr_inner">
